...
impl MascalValue {
    pub fn equals(left: &MascalValue, right: &MascalValue) -> Result<MascalValue, MascalError> {
        comparison_arms!(left, right, eq, |v1, v2| {
            match (v1, v2) {
                ...
                (MascalValue::Type(t1), MascalValue::Type(t2)) => {
                    Ok(MascalValue::Boolean(t1.eq(&t2)))
                }

                (MascalValue::Boolean(b1), MascalValue::Boolean(b2)) => {
                    Ok(MascalValue::Boolean(b1.eq(&b2)))
                }
    ...
    pub fn not_equals(left: &MascalValue, right: &MascalValue) -> Result<MascalValue, MascalError> {
        comparison_arms!(left, right, ne, |v1, v2| {
            match (v1, v2) {
                ...
                (MascalValue::Type(t1), MascalValue::Type(t2)) => {
                    Ok(MascalValue::Boolean(t1.ne(&t2)))
                }

                (MascalValue::Boolean(b1), MascalValue::Boolean(b2)) => {
                    Ok(MascalValue::Boolean(b1.ne(&b2)))
                }
    ...
    pub fn less_than(left: &MascalValue, right: &MascalValue) -> Result<MascalValue, MascalError> {
