...
pub fn unwrap_index_layers(
    variable: MascalExpression, variable_table: Rc<RefCell<VariableTable>>,
    ...
    while let MascalExpression::IndexExpression { 
        array, 
        index,
        is_dynamic 
    } = base {
        let index_val = execute_expression(*index, Rc::new(RefCell::new(ExecutionData {
